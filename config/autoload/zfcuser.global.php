...
$settings = array(
     ...
     *
     */
    // vasconcelos 'login_redirect_route' => 'other', //mexi
    'login_redirect_route' => function(\ZfcUser\Entity\UserInterface $user)
    {
        // a função getRole eu adicionei em Applicatio/Entity/User.php
        if($user->getRole()=='admin' || $user->getRole()=='administracao')
        {
            return 'admin';
